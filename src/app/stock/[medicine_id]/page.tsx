...
// import WarehouseLayout from "@/components/order/stock/new/warehouse-Layout";
...
//   if (!medicine) {
//     return <div>Không có thông tin thuốc</div>;
//   }
...
const StockDetailPage: React.FC = () => {
  ...
  const stocks = data.data;
  // ✅ FIX: Remove 'any' type and add proper type checking
  const medicine = stocks[0]?.medicine;
  if (!medicine) {
    return (
      <WarehouseLayout>
